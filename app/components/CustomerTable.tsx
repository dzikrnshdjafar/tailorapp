...
const CustomerTable: React.FC<CustomerTableProps> = ({ clothingTypeFilter, clothingTypes }) => {
  ...
  const handleSave = async (customerId: number, clothingType: string) => {
    ...
    setIsProcessing(customerId); // Set state untuk menandakan proses sedang berjalan
    ...
    try {
      ...
      setIsProcessing(null); // Reset state setelah proses selesai
    }
  };
                  ...
                  {clothingTypeFilter ? (
                    editingCustomerId === customer.id ? (
                      <>
                        ...
                        >
                          {isProcessing === customer.id ? "Editing..." : "Save"}
                        </button>
                        <button
                      ...
                      <>
                        <button
                          ...
                          disabled={isProcessing === customer.id}
                        >
                          {isProcessing === customer.id ? "Editing..." : "Edit"}
                        </button>
                        <button
                          ...
                          disabled={isProcessing === customer.id}
                        >
                          {isProcessing === customer.id ? "Deleting..." : "Delete"}
                        </button>
                      </>
                    )
                  ) : (
